    ...
    private void showTongjiData(HuoDongTongji yiXiangJin) {
        ...
        mButton4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                submit(startDate,endDate,situation,activity_id,merchantId);
            }
        });

    }

    private void submit(String startDate, String endDate, String situation, final String activity_id, final String merchantId) {

        String url = BaseUrl.BASE_URL+"orderController.do?method=subOrderCountForApp&token_id="+token_id+"&page=1"+"&rows=10&loginOS=2&merchantId="+merchantId+"&activityId="+ activity_id;
...
//        }
//        else {
            url = BaseUrl.BASE_URL+"orderController.do?method=subOrderCountForApp&token_id="+token_id+"&page=1"+"&rows=10&loginOS=2&merchantId="+merchantId+"&activityId="+ activity_id;
    ...
    private void showTabData(List<DaidanTongji.DataListBean> signPeopleData) {
        ...
        mMyCoustomerAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                startActivity(new Intent(getActivity(),SellCardActivity.class));
            }
        });
    }
