...
public class DingjinFragment extends BaseFragment  {
    ...
    private int xoff;
    private static final int REQUEST_CODE_RICHANG= 2008;
                ...
                mTopRightMenu
                        ...
                        .setOnMenuItemClickListener(new TopRightMenu.OnMenuItemClickListener() {
                            ...
                            public void onMenuItemClick(int position) {
                                if(position==0){
                                    startActivityForResult(new Intent(getActivity(), DailyOrderActivity.class),REQUEST_CODE_RICHANG);
                                }
                                else if(position==1){
...
//                        .showAsDropDown(moreBtn);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==REQUEST_CODE_RICHANG){
