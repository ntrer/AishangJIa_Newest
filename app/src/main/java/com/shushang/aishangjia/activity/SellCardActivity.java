...
public class SellCardActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private List<ShouKaDetail.DataBean.GoodsOrderVosBean> goodsOrderVos=new ArrayList<>();
    ...
    private void getData(String cardNum, String huodongId) {
        ...
        String url = BaseUrl.BASE_URL+"goodsOrderController.do?method=getShouKaDetails&token_id="+token_id+"&loginOS=2"+"&cardNum="+cardNum+"&activityId="+huodongId;
        Log.d("BaseUrl", url);
        try {
            RestClient.builder()
                    .url(url)
                            ...
                            if(response!=null){
                                try {
                                    ...
                                    if(activityList.getRet().equals("200")){
                                        ...
                                        if(data!=null){
                                            showTabData(data);
                                            goodsOrderVos = data.getGoodsOrderVos();
    ...
    private void showData(List<ShouKaDetail.DataBean.GoodsOrderVosBean> goodsOrderVos) {
        mMyCoustomerAdapter=new SellCardAdapter(R.layout.item_sell_card,goodsOrderVos);
